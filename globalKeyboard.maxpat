...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 192.0, 441.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 430.0, 66.0, 20.0 ],
					"style" : "",
					"text" : "keydown"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 81.0, 423.0, 20.0 ],
					"style" : "",
					"text" : "Provide global keyboard (and potentially mouse) in Max thanks to java."
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-5",
					"ignoreclick" : 1,
					"jsarguments" : [ "Global Keyboard" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 13.0, 14.0, 457.0, 56.0 ]
				}
